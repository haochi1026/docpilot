-- Canonical initial DocPilot schema. Do not edit this migration after it has
-- reached a shared environment; add a new numbered migration instead.
...
CREATE TABLE kb_permission_audit (
  id BIGINT PRIMARY KEY AUTO_INCREMENT,
  kb_id BIGINT NOT NULL,
...
CREATE TABLE document_chunk_term (
